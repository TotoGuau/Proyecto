...
public class ProductosView{
    ...
    private void BeginProductos(){  
        pd.Init();
        
        String[] columnas = {"Codigo","Nombre","Descripcion","Cantidad","Precio"};
        
        DefaultTableModel model= new DefaultTableModel(pd.ProductosList(),columnas);
        ...
        button6.setBounds((int) Math.ceil(panel1.getBounds().width * 0.72),(int) Math.ceil(panel1.getBounds().height * 0.61),(int) Math.ceil(panel1.getBounds().width * 0.27),(int) Math.ceil(panel1.getBounds().height * 0.34));
