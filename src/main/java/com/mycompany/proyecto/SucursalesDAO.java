...
public class SucursalesDAO {
    ...
    public void PdfSucursal() throws FileNotFoundException, DocumentException {
        FileOutputStream output= new FileOutputStream("ReporteSucursales.pdf");
        ...
        try{
            ...
            while (rs.next()) {
                ...
                document.add(new Paragraph("Direccion: " + rs.getString(3)));
                document.add(new Paragraph("Correo: " + rs.getString(4)));
                document.add(new Paragraph("Teléfono: " + rs.getString(5)));
                document.add(new Paragraph("\n\n"));
            }  
        }catch(Exception e){
        }
        ...
        try {
            File file= new File("ReporteSucursales.pdf");
